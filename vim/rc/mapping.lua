...
local set_prefix = function(name, key)
  local name_key = ("[%s]"):format(name)
  set({ "n", "x" }, name_key, "<Nop>")
  set({ "n", "x" }, key, name_key, remap)
end

set_prefix("exec", "<Space>x")
set_prefix("keyword", "<Space>k")
set_prefix("diff", "<Leader>d")
set_prefix("edit", "<Space>e")
set_prefix("file", "<Space>f")
set_prefix("operator", "<Space><Leader>")
set_prefix("git", "<Leader>g")
set_prefix("test", "<Leader>t")
set_prefix("substitute", "<Space>s")
set_prefix("finder", "<Space>d")
set_prefix("buf", "<Space>b")
set_prefix("indent", "<Space>i")
set_prefix("qf", "<Space>q")
set_prefix("winmv", "m")
set_prefix("win", "<Space>w")
set_prefix("tab", "t")
set_prefix("term", "<Space>t")
set_prefix("arith", "<Space>a")
set_prefix("yank", "<Space>y")
set_prefix("newline", "o")
