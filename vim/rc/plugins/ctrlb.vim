...
autocmd MyAuGroup User CtrlbSourceLoad ++once call s:settings()
function! s:settings() abort

    call ctrlb#config#set('executable_client', 'wsxhub')
    call ctrlb#config#set('executable_server', 'wsxhub')
