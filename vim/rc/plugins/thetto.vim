...
nnoremap [finder]to <Cmd>lua require("thetto").start("test", {opts = {action = "execute", auto = "preview"}})<CR>
nnoremap [finder]ts <Cmd>lua require("thetto").start("test", {source_opts = {scoped = true}, opts = {action = "execute", auto = "preview"}})<CR>
