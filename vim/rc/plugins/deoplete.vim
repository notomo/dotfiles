...
let s:sources.python = ['LanguageClient', 'file', 'buffer', 'around', 'neosnippet']
let s:sources.go = ['LanguageClient', 'file', 'buffer', 'around', 'neosnippet']
...
let s:sources['rust'] = ['LanguageClient', 'buffer', 'file', 'around', 'neosnippet']
" let s:sources['rust'] = ['lsp', 'buffer', 'file', 'around', 'neosnippet']
let s:sources.javascript = ['file', 'buffer', 'around', 'neosnippet']
let s:sources.typescript = ['LanguageClient', 'file', 'buffer', 'around', 'neosnippet']
