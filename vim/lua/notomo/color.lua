...
vim.api.nvim_set_hl(0, "ReplacedText", { fg = pallet.black, bg = pallet.yellow })
...
vim.api.nvim_set_hl(0, "@keyword.import.go", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@constant.builtin.go", { link = "Constant" })
vim.api.nvim_set_hl(0, "@constant.go", {})
vim.api.nvim_set_hl(0, "@constructor.moonbit", { link = "@variable" })
vim.api.nvim_set_hl(0, "@constant.moonbit", { link = "@variable" })
...
vim.api.nvim_set_hl(0, "@keyword.conditional.go", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@module.go", {})
vim.api.nvim_set_hl(0, "@function.method.call.go", {})
vim.api.nvim_set_hl(0, "@function.method.go", {})
vim.api.nvim_set_hl(0, "@keyword.repeat.go", { link = "Statement" })
vim.api.nvim_set_hl(0, "@keyword.go", {})
vim.api.nvim_set_hl(0, "@keyword.strong.go", { link = "Keyword" })
...
vim.api.nvim_set_hl(0, "@function.tsx", {})
vim.api.nvim_set_hl(0, "@type.tsx", {})
vim.api.nvim_set_hl(0, "@module.tsx", {})
vim.api.nvim_set_hl(0, "@keyword.return.tsx", { link = "Statement" })
vim.api.nvim_set_hl(0, "@keyword.conditional.ternary.tsx", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.conditional.tsx", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.operator.tsx", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.import.tsx", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.tsx", { link = "Identifier" })

vim.api.nvim_set_hl(0, "@keyword.conditional.ternary.typescript", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.return.typescript", { link = "Statement" })
vim.api.nvim_set_hl(0, "@keyword.typescript", { link = "Identifier" })
vim.api.nvim_set_hl(0, "@keyword.import.typescript", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.conditional.typescript", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@keyword.operator.typescript", { link = "Conditional" })
vim.api.nvim_set_hl(0, "@function.typescript", {})
vim.api.nvim_set_hl(0, "@type.typescript", {})
vim.api.nvim_set_hl(0, "@module.typescript", {})
vim.api.nvim_set_hl(0, "@punctuation.special.typescript", { link = "Identifier" })
